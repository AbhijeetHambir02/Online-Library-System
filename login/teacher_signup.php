...
<body>
    ...
    <form class="myform" action="teacher_signup.php" method="POST" autocomplete="off">
        ...
        <input name="teacher_id" class="inputvalue" type="text" placeholder="teacher-id" value="<?php if(isset($_POST['teacher_id'])) echo $_POST['teacher_id']; ?>" required>
        </div>
...
<?php
    ...
    $mob="/^\d{10}$/";
        ...
        else if($password==$cpassword)
        {
            ...
            {
                $query1 = "INSERT INTO teacher VALUES('$name','$email','$department','$mobile','$password','$teacher_id')";
