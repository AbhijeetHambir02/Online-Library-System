...
<html>
<head>
    <link href="assets/css/returnbooks.css" type="text/css" rel="stylesheet">
     ...
     <div class="container">
          <div class="table-container">
            <?php
               ...
               $query = "SELECT * FROM return_book WHERE STUDENT_EMAIL='$student_emailid'";
               ...
               <?php
                    ...
                    echo '<tr>';
                         ...
                         echo '<td>'; echo $data['ISSUE_DATE']; echo '</td>';
                         echo '<td>'; echo $data['RETURN_DATE']; echo '</td>';
                    echo '</tr>';
                    }
                    echo '</table>';
               }
